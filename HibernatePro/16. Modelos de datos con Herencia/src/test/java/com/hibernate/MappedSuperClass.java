...
import com.hibernate.mappedsuperclass.Customer;
import com.hibernate.mappedsuperclass.Employee;
...
//        var emps = session.createQuery("select e from Employee e", Employee.class).list();
