...
import com.hibernate.mappedsuperclass.User;
import com.hibernate.tableperclass.Car;
import com.hibernate.tableperclass.Motorcycle;
import com.hibernate.tableperclass.Owner;
import com.hibernate.tableperclass.Vehicle;
...
Las tablas no estan relacionadas entre si, repiten las columnas de la tabla base.
 */
    @Test
    void tablePerClass() {
        insertDemoData();
